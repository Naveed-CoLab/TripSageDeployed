          ...
          {isHistoryLoading ? (
            ...
            <div className="divide-y divide-gray-100">
              {filteredAndSortedHistory.map((search) => {
                ...
                // Validate dates
                const departureDate = search.departureDate ? new Date(search.departureDate) : null;
                const returnDate = search.returnDate ? new Date(search.returnDate) : null;
                const createdAt = search.createdAt ? new Date(search.createdAt) : null;
                
                // Skip invalid entries
                if (!search.originLocationCode || !search.destinationLocationCode || !departureDate || isNaN(departureDate.getTime())) {
                  return null;
                }
                        ...
                        <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-gray-500">
                          <div className="flex items-center">
                            ...
                            <span>
                              ...
                              {returnDate && !isNaN(returnDate.getTime()) && ` - ${returnDate.toLocaleDateString('en-US', {
                                month: 'short',
                                day: 'numeric',
                                year: 'numeric'
                              })}`}
