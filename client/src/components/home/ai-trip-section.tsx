        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
          ...
          <div className="mt-10 lg:mt-0">
            <div className="bg-gray-100 rounded-xl overflow-hidden shadow-lg">
              <img 
                className="w-full" 
                src="https://images.unsplash.com/photo-1488646953014-85cb44e25828?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1200&q=80" 
                alt="AI Trip Planning - Travel destinations around the world" 
              />
